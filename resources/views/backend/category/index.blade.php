...
<div class="page-content">
    <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
        <div class="breadcrumb-title pe-3">{{__('Category')}}</div>
        <div class="ps-3">
             ...
             <tbody>
              ...
              @endphp
               ...
               <tr>
                 ...
                 <td>{{ $dataInfo->name }}</td>
                 <td>
                    <form  method="post" action="{{ url('/category/destroy/'.$dataInfo->id) }}" class="delete_form">
                      {{ csrf_field() }}
                      {{ method_field('DELETE') }}
                      <div class="btn-group btn-corner">
                        <a href="#" class="btn btn-xs btn-primary categoryEdit">Edit</a>
      ...
      <div class="modal-dialog modal-lg">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLabel">{{__('New Category Creation')}}</h5>
...
<script type="text/javascript">
  $(document).ready(function() {
    ...
    $('.categoryEdit').on('click',function() {
        ...
        $('#editForm').attr('action','{{route("category.update",$dataInfo)}}');
