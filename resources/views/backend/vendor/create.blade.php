        ...
        <div class="ps-3">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0 p-0">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">{{__('Vendor Create')}}</li>
                </ol>
            </nav>
        </div>
        <div class="ms-auto">
            ...
            <div class="row">
                <div class="col-md-8 m-auto ">
                    <div class="card">
                        ...
                        @endif
                        <div class="card-body">
                            <form method="POST" method="post" action="{{ route('vendor.store') }}">
                                @csrf
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input id="due" type="number" class="form-control" name="due" value="0.00" required autofocus>
                                </div>
                                <div class="mb-3">
