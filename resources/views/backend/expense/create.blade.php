        ...
        <div class="ps-3">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0 p-0">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">{{__('Expense Create')}}</li>
                </ol>
            </nav>
        </div>
        <div class="ms-auto">
        ...
        <section id="font-livicons">
            <div class="row">
                <div class="col-md-8 m-auto ">
                    <div class="card">
                        <div class="card-header text-center"><h4>{{__('Expense create')}}</h4></div>
                        @if (count($errors) > 0)
                        ...
                        @endif
                        <div class="card-body">
                            <form method="POST" method="post" action="{{ route('expense.store') }}">
                                @csrf
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input id="expense_for" type="text" class="form-control " name="expense_for" value="{{old('expense_for')}}" required autofocus>
                                </div>
                                <div class="mb-3">
