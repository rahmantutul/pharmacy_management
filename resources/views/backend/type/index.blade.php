...
<div class="page-content">
    <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
        <div class="breadcrumb-title pe-3">{{__('Type')}}</div>
        <div class="ps-3">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0 p-0">
                    <li class="breadcrumb-item"><a href="javascript:;"><i class="bx bx-home-alt"></i></a>
                    </li>
                    <li class="breadcrumb-item active" aria-current="page">{{__('Type List')}}</li>
                </ol>
            </nav>
        </div>
        <div class="ms-auto">
             ...
             <tbody>
              ...
              @endphp
               ...
               <tr>
                 ...
                 <td>{{ $dataInfo->name }}</td>
                 <td>
                    <form  method="post" action="{{ route('type.destroy',$dataInfo->id) }}" class="delete_form">
                      {{ csrf_field() }}
                      {{ method_field('DELETE') }}
                      <div class="btn-group btn-corner">
                        <a href="#" class="btn btn-xs btn-primary typeEdit">Edit</a>
      ...
      <div class="modal-dialog modal-lg">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLabel">{{__('New Type Creation')}}</h5>
                ...
                <div class="col-md-8">
                  <div class="input-group mb-3">
                    <div class="input-group-prepend">
                      <span class="input-group-text">{{__('Type Name')}} &nbsp;:</span>
                    </div>
...
<script type="text/javascript">
  $(document).ready(function() {
    ...
    $('.typeEdit').on('click',function() {
        ...
        $('#editForm').attr('action','{{route("type.update",$dataInfo)}}');
