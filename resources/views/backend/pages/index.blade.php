         ...
         <div class="col-12 col-lg-4 d-flex">
           <div class="card radius-10 w-100">
               ...
               <div class="dashboard-top-countries mb-3 p-3">
                   ...
                   <div class="row mb-4">
                       <div class="col-2">
                           <img src="{{asset('backend/assets/images/icons/united-states.png')}}" width="42" alt="">
                       </div>
                       <div class="col">
                   ...
                   <div class="row mb-4">
                       <div class="col-2">
                           <img src="{{asset('backend/assets/images/icons/germany.png')}}" width="42" alt="">
                       </div>
                       <div class="col">
                   ...
                   <div class="row mb-4">
                       <div class="col-2">
                           <img src="{{asset('backend/assets/images/icons/canada.png')}}" width="42" alt="">
                       </div>
                       <div class="col">
                   ...
                   <div class="row mb-4">
                       <div class="col-2">
                           <img src="{{asset('backend/assets/images/icons/india.png')}}" width="42" alt="">
                       </div>
                       <div class="col">
                   ...
                   <div class="row mb-4">
                       <div class="col-2">
                           <img src="{{asset('backend/assets/images/icons/netherlands.png')}}" width="42" alt="">
                       </div>
                       <div class="col">
                   ...
                   <div class="row mb-0">
                       <div class="col-2">
                           <img src="{{asset('backend/assets/images/icons/malaysia.png')}}" width="42" alt="">
                       </div>
                       <div class="col">
