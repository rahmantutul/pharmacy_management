...
<div class="page-content">
    <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
        <div class="breadcrumb-title pe-3">{{__('Method')}}</div>
        <div class="ps-3">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0 p-0">
                    <li class="breadcrumb-item"><a href="javascript:;"><i class="bx bx-home-alt"></i></a>
                    </li>
                    <li class="breadcrumb-item active" aria-current="page">{{__('Method List')}}</li>
                </ol>
            </nav>
        </div>
        <div class="ms-auto">
             ...
             <tbody>
              ...
              @endphp
               ...
               <tr>
                 <td>{{ $dataInfo->id }}</td>
                 <td>{{ $dataInfo->name }}</td>
                 <td>{{ $dataInfo->balance }}</td>
                 <td>
                    <form  method="post" action="{{ route('payment.destroy',$dataInfo->id) }}" class="delete_form">
                      {{ csrf_field() }}
                      {{ method_field('DELETE') }}
                      <div class="btn-group btn-corner">
                        <a href="#" class="btn btn-xs btn-primary paymentEdit">Edit</a>
      ...
      <div class="modal-dialog modal-lg">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLabel">{{__('New Method Creation')}}</h5>
              ...
              <div class="row">
                <div class="col-md-8">
                  <div class="input-group mb-3">
                    <div class="input-group-prepend">
                      <span class="input-group-text">{{__('Method Name')}} &nbsp;:</span>
                    </div>
                ...
                <div class="col-md-8">
                  <div class="input-group mb-3">
                    ...
                    <input type="number" name="balance" class="form-control" placeholder="" required>
                  </div>
              </div>
              </div>
...
<script type="text/javascript">
  $(document).ready(function() {
    ...
    $('.paymentEdit').on('click',function() {
        ...
        $('#editForm').attr('action','{{route("payment.update",$dataInfo)}}');
